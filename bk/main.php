...
function bntm_shortcode_bk_dashboard()
{
    ...
    <div class="bntm-booking-container">
        <div class="bntm-tabs">
            ...
            <a href="?tab=bookings" class="bntm-tab <?php echo $active_tab === 'bookings' ? 'active' : ''; ?>">All
                Bookings</a>
            <?php if ($can_view_all_tabs): ?>
                ...
                <?php if (bntm_is_module_enabled('fn') && bntm_is_module_visible('fn')): ?>
                    <a href="?tab=import" class="bntm-tab <?php echo $active_tab === 'import' ? 'active' : ''; ?>">Import to
                        Finance</a>
                <?php endif; ?>
    ...
    <?php if ($booking_url): ?>
        <div class="bntm-form-section" style="background: #eff6ff; border-left: 4px solid #3b82f6;">
            ...
            <div style="display: flex; align-items: center; gap: 15px; flex-wrap: wrap;">
                <input type="text" id="booking-url" value="<?php echo esc_url($booking_url); ?>" readonly
...
function bk_services_tab($business_id)
{
                        ...
                        <tr data-service-id="<?php echo $service->id; ?>">
                            ...
                            <td>
                                <label class="bk-toggle">
                                    <input type="checkbox" class="bk-toggle-status" data-id="<?php echo $service->id; ?>"
                                        data-nonce="<?php echo $nonce; ?>" <?php checked($service->status, 'active'); ?>>
                                    <span class="bk-toggle-slider"></span>
                                </label>
                                <span class="status-text"><?php echo ucfirst($service->status); ?></span>
                            </td>
                            <td>
                                <button class="bntm-btn-small bk-edit-service" data-id="<?php echo $service->id; ?>"
                                    data-nonce="<?php echo $nonce; ?>">Edit</button>
                                <button class="bntm-btn-small bntm-btn-danger bk-delete-service"
                                    data-id="<?php echo $service->id; ?>" data-nonce="<?php echo $nonce; ?>">Delete</button>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
    ...
    <div class="bntm-form-section" style="background: #f9fafb; border-left: 4px solid #3b82f6;">
        ...
        <?php if ($limit_reached): ?>
            <div
                style="background: #fef3c7; border: 1px solid #fde047; padding: 15px; border-radius: 4px; margin-bottom: 15px;">
                <strong>⚠️ Service Limit Reached:</strong> Maximum of <?php echo $service_limit; ?> services allowed. This is a
                warning-only limit, but consider upgrading your plan.
            </div>
        <?php endif; ?>
                    ...
                    <?php foreach ($bookings as $booking):
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <small><?php echo date('H:i', strtotime($booking->start_time)); ?> -
                                    <?php echo date('H:i', strtotime($booking->end_time)); ?></small>
                            </td>
                            <td><?php echo bk_format_price($booking->total); ?></td>
                            <td>
                                <select class="bk-booking-status" data-booking-id="<?php echo esc_attr($booking->rand_id); ?>"
            ...
            <tbody>
                <?php foreach ($hours as $hour):
                    ...
                    <tr>
                        ...
                        <td>
                            <label class="bk-toggle">
                                <input type="checkbox" class="bk-is-open" data-id="<?php echo $hour->id; ?>"
                                    data-nonce="<?php echo $nonce; ?>" <?php checked($hour->is_open, 1); ?>>
                                <span class="bk-toggle-slider"></span>
                            </label>
                        </td>
                        <td>
                            <input type="time" class="bk-start-time" data-id="<?php echo $hour->id; ?>"
                                data-nonce="<?php echo $nonce; ?>" value="<?php echo esc_attr($hour->start_time); ?>"
                                style="padding: 6px 8px; border: 1px solid #d1d5db; border-radius: 4px;">
                        </td>
                        <td>
                            <input type="time" class="bk-end-time" data-id="<?php echo $hour->id; ?>"
                                data-nonce="<?php echo $nonce; ?>" value="<?php echo esc_attr($hour->end_time); ?>"
                                style="padding: 6px 8px; border: 1px solid #d1d5db; border-radius: 4px;">
                        </td>
                        <td>
        ...
        <form id="bk-booking-settings" class="bntm-form">
            <div class="bntm-form-group">
                ...
                <select name="slot_interval">
                    <option value="15" <?php selected(bntm_get_setting('bk_slot_interval', '30'), '15'); ?>>15 minutes
                    </option>
                    <option value="30" <?php selected(bntm_get_setting('bk_slot_interval', '30'), '30'); ?>>30 minutes
                    </option>
                    <option value="60" <?php selected(bntm_get_setting('bk_slot_interval', '30'), '60'); ?>>60 minutes
                    </option>
                </select>
            ...
            <div class="bntm-form-group">
                ...
                <input type="number" name="advance_booking_days"
                    value="<?php echo esc_attr(bntm_get_setting('bk_advance_booking_days', '30')); ?>" min="1">
            ...
            <div class="bntm-form-group">
                ...
                <select name="currency">
                    <option value="USD" <?php selected(bntm_get_setting('bk_currency', 'USD'), 'USD'); ?>>USD - US Dollar
                    </option>
                    <option value="EUR" <?php selected(bntm_get_setting('bk_currency', 'USD'), 'EUR'); ?>>EUR - Euro
                    </option>
                    <option value="GBP" <?php selected(bntm_get_setting('bk_currency', 'USD'), 'GBP'); ?>>GBP - British
                        Pound</option>
                    <option value="PHP" <?php selected(bntm_get_setting('bk_currency', 'USD'), 'PHP'); ?>>PHP - Philippine
                        Peso</option>
                </select>
            </div>
            ...
            <div class="bntm-form-group">
                ...
                <input type="number" name="tax_rate" step="0.01"
                    value="<?php echo esc_attr(bntm_get_setting('bk_tax_rate', '0')); ?>">
            </div>
                            ...
                            <div class="bk-closed-date-item">
                                <div class="bk-closed-date-main">
                                    <div class="bk-closed-date-calendar">
                                        <span
                                            class="bk-closed-date-month"><?php echo esc_html(date('M', strtotime($entry['date']))); ?></span>
                                        <span
                                            class="bk-closed-date-day"><?php echo esc_html(date('d', strtotime($entry['date']))); ?></span>
                                    </div>
                                    <div class="bk-closed-date-content">
                                        <strong><?php echo esc_html(date('F j, Y', strtotime($entry['date']))); ?></strong>
                                        <span
                                            class="bk-closed-date-meta"><?php echo esc_html(date('l', strtotime($entry['date']))); ?></span>
                                ...
                                <button type="button" class="bntm-btn-small bntm-btn-danger bk-remove-closed-date"
...
function bk_settings_tab($business_id)
{
    ...
    <div class="bntm-form-section">
        ...
        <div class="bntm-form-group">
            ...
            <textarea name="bk_description" id="bk-description" rows="3"
                placeholder="Brief description shown on booking page"><?php echo esc_textarea(bntm_get_bk_description()); ?></textarea>
            <small>This appears below the title on your booking calendar.</small>
        </div>

        <div class="bntm-form-group">
            <label>Booking Terms & Conditions</label>
            <textarea name="bk_terms" id="bk-terms" rows="6"
                placeholder="Enter your booking terms and conditions"><?php echo esc_textarea(bntm_get_bk_terms()); ?></textarea>
    ...
    <div class="bntm-form-section" id="bk-payment-methods-section"
                ...
                <?php foreach ($payment_methods as $index => $method): ?>
                    <div class="payment-method-item" data-index="<?php echo $index; ?>">
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            ...
                            <div>
                                <button class="bntm-btn-small bntm-btn-secondary edit-payment-method"
                                    data-index="<?php echo $index; ?>">Edit</button>
        ...
        <div style="margin-top: 20px; padding: 20px; background: #f9fafb; border-radius: 8px;">
            ...
            <form id="add-payment-method-form" class="bntm-form">
                ...
                <div class="bntm-form-group">
                    ...
                    <textarea name="payment_description" id="payment-description" rows="3"
                ...
                <div style="display: flex; gap: 10px;">
                    ...
                    <button type="button" class="bntm-btn-secondary" id="cancel-edit-btn"
...
function bntm_shortcode_bk_calendar()
{
    ...
    <div class="bk-booking-container">
        ...
        <!-- Calendar View -->
        <div id="customer-calendar-view" class="customer-calendar-fade-in"
        ...
        <!-- Slots View -->
        <div id="customer-slots-view" class="customer-slots-fade-in"
            ...
            <div class="bk-slots-wrapper">
                ...
                <div class="bk-services-selector">
                    ...
                    <select id="customer-service-filter"
                        style="width: 100%; max-width: 400px; padding: 10px; border: 1px solid #d1d5db; border-radius: 6px;">
                        <option value="">All Services</option>
                        <?php foreach ($services as $service): ?>
                            <option value="<?php echo $service->id; ?>"><?php echo esc_html($service->name); ?>
                                (<?php echo $service->duration; ?> min - <?php echo bk_format_price($service->price); ?>)
                            </option>
                        <?php endforeach; ?>
                    </select>
                </div>
            ...
            <form id="booking-form" class="bntm-form">
                <div class="bk-booking-summary">
                    ...
                    <div style="margin: 15px 0;">
                        <label style="display: block; font-weight: 600; margin-bottom: 8px;">Quantity (Number of
                            Slots):</label>
                        ...
                        <small style="color: #6b7280; display: block; margin-top: 8px;">Select consecutive time slots
                            (1-10)</small>
                    </div>

                    <div id="quantity-calculation"
                        style="background: #f0f9ff; padding: 12px; border-radius: 6px; margin-top: 10px;">
                    ...
                    <div id="availability-warning"
                        style="display: none; background: #fef3c7; border: 1px solid #fde047; padding: 10px; border-radius: 6px; margin-top: 10px; color: #92400e;">
                ...
                <button type="submit" class="bntm-btn-primary bntm-btn-large" id="complete-booking-btn"
...
function bk_bookings_calendar_tab($business_id)
{
    ...
    <div class="bk-admin-calendar-main">
        ...
        <!-- Slots View -->
        <div id="admin-slots-view" class="admin-slots-fade-in"
            style="display: none; opacity: 0; transition: opacity 0.3s ease;">
            <div class="bk-admin-slots-wrapper">
                ...
                <div class="bk-services-selector">
                    ...
                    <select id="admin-service-filter"
                        ...
                        <?php foreach ($services as $service): ?>
                            <option value="<?php echo $service->id; ?>"><?php echo esc_html($service->name); ?>
                                (<?php echo $service->duration; ?> min)</option>
                        <?php endforeach; ?>
                    </select>
                </div>
        ...
        <div class="bk-modal-content">
            ...
            <form id="admin-edit-booking-form" class="bntm-form">
                ...
                <div class="bk-info-display">
                    ...
                    <div class="bk-info-value" id="admin-total"
                        style="font-weight: bold; font-size: 1.2em; color: #059669;"></div>
                </div>
    ...
    <div id="admin-create-booking-modal" class="bk-modal">
        ...
        <div class="bk-modal-content">
            ...
            <form id="admin-create-booking-form" class="bntm-form">
                    ...
                    <select id="create-service-id" name="service_id" required>
                        ...
                        <?php foreach ($services as $service): ?>
                            <option value="<?php echo $service->id; ?>" data-duration="<?php echo $service->duration; ?>"
                                ...
                                <?php echo esc_html($service->name); ?> (<?php echo $service->duration; ?> min -
                                <?php echo bk_format_price($service->price); ?>)
                            </option>
                        <?php endforeach; ?>
                    </select>
                </div>
                    ...
                    <div class="bntm-form-group" style="flex: 1;">
                        ...
                        <div style="display: flex; align-items: center; gap: 8px;">
                            ...
                            <input type="number" id="create-quantity" name="quantity" min="1" max="10" value="1" readonly
                                style="width: 100%; padding: 8px; border: 2px solid #d1d5db; border-radius: 6px; font-size: 16px; font-weight: 600; text-align: center;"
                                required>
                ...
                <div class="bk-create-summary"
                    style="background: #f0f9ff; padding: 15px; border-radius: 8px; margin-bottom: 20px;">
                    ...
                    <div
                        style="display: flex; justify-content: space-between; border-top: 2px solid #3b82f6; padding-top: 8px; margin-top: 8px;">
                        <span style="font-size: 1.1em;"><strong>Total:</strong></span>
                        <span id="create-total-display"
                            style="font-size: 1.2em; font-weight: bold; color: #059669;">₱0.00</span>
                    </div>
                </div>
                ...
                <div class="bntm-form-group">
                    ...
                    <input type="text" id="create-payment-method" name="payment_method"
                        placeholder="e.g., Cash, GCash, Bank Transfer" required>
                </div>
                <div class="bntm-form-group">
                    <label>Payment Status *</label>
    ...
    <div class="bntm-container">
        <div class="bntm-content">
                ...
                <table class="bk-transaction-table">
                    ...
                    <tr>
                        ...
                        <td><?php echo date('g:i A', strtotime($booking->start_time)); ?> -
                            <?php echo date('g:i A', strtotime($booking->end_time)); ?></td>
                    </tr>
                    <!--<tr>
            ...
            <div style="margin-top: 30px; text-align: center;">
                <a href="<?php echo get_permalink(get_page_by_path('book-appointment')); ?>"
                    class="bntm-btn bntm-btn-primary">
...
function bntm_fn_bookings_tab()
{
    ...
    <div class="bntm-form-section">
        ...
        <div style="margin-bottom: 15px;">
            <label for="bk-import-month-filter" style="display:block; margin-bottom: 6px; font-weight: 600;">Filter by
                Month</label>
        ...
        <?php else: ?>
            ...
            <div style="margin-bottom: 15px;">
                <button id="bulk-import-btn" class="bntm-btn-primary" data-nonce="<?php echo $nonce; ?>"
                        ...
                        <?php foreach ($bookings as $booking): ?>
                            <tr class="booking-eligible">
                                ...
                                <td>
                                    ...
                                    <small style="color: #6b7280;">to
                                        <?php echo date('h:i A', strtotime($booking->end_time)); ?></small>
                                </td>
