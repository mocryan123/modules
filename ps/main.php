...
function ps_overview_tab($business_id) {
  ...
  <!-- Quick Action Bar with keyboard shortcuts — original colors preserved -->
    ...
    <div style="display:flex;gap:14px;flex-wrap:wrap;font-size:11px;color:#6b7280;margin-bottom:14px;padding:0 2px;">
        <?php
        $hints = [
            'Alt+N' => 'New Ticket',
            'Alt+C' => 'Add Customer',
        ...
        foreach ( $hints as $key => $label ) {
            echo '<span style="display:inline-flex;align-items:center;gap:5px;">';
            echo '<kbd style="background:#f3f4f6;border:1px solid #d1d5db;border-bottom-width:2px;border-radius:4px;padding:1px 6px;font-size:10px;font-family:monospace;color:#374151;">' . $key . '</kbd>';
