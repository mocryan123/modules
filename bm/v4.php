...
function bntm_shortcode_bm_book_hotel() {
    ...
    <div class="bm-customer-booking-container">
        <div class="bm-booking-header">
            ...
            <p>Select your rooms and complete the booking request</p>
        </div>
                    ...
                    <div class="room-selection-item">
                        <div class="bm-form-row">
                            <div class="bm-form-group">
                                ...
                                <select name="rooms[0][room_type]" class="room-type-select" data-index="0" required>
...
function bntm_ajax_bm_submit_booking() {
    ...
    try {
        ...
        if (!$booking_insert) {
            ...
            throw new Exception('Failed to create booking'.$error_message);
        }
